...
Loot at [Kaer Dhu](https://witcher.fandom.com/wiki/Kaer_Dhu "Kaer Dhu")
...
lw_sk86_old_mans_key

**Alchemist's key** is a key and [quest item](https://witcher.fandom.com/wiki/The_Witcher_3_quest_items "The Witcher 3 quest items") in _[The Witcher 3: Wild Hunt](https://witcher.fandom.com/wiki/The_Witcher_3:_Wild_Hunt "The Witcher 3: Wild Hunt")_ and is used to unlock a chest just inside the entrance in [Kaer Dhu](https://witcher.fandom.com/wiki/Kaer_Dhu "Kaer Dhu"). 

It can be found guarded by a [nekker warrior](https://witcher.fandom.com/wiki/Nekker_warrior "Nekker warrior"), alongside a [letter](https://witcher.fandom.com/wiki/Letter_from_an_alchemist "Letter from an alchemist"), deep inside the tunnel.

---
*Source: [Alchemist's key](https://witcher.fandom.com/wiki/Alchemist's_key) on Witcher Wiki, licensed under [CC-BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).*
